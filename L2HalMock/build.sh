...
echo -e "${GREEN}========================================Copy Patch File for iarmmgrs===============================================${NC}"
cd $WORKSPACE/deps/rdk/iarmmgrs
rm build.sh
rm Makefile
cp $SCRIPTS_DIR/patches/rdkservices/iarmmgrs/build.sh $WORKSPACE/deps/rdk/iarmmgrs
cp $SCRIPTS_DIR/patches/rdkservices/iarmmgrs/Makefile $WORKSPACE/deps/rdk/iarmmgrs

cd $WORKSPACE/deps/rdk/iarmmgrs/dsmgr
rm dsMgr.c
rm Makefile
cp $SCRIPTS_DIR/patches/rdkservices/iarmmgrs/dsmgr/dsMgr.c $WORKSPACE/deps/rdk/iarmmgrs/dsmgr
cp $SCRIPTS_DIR/patches/rdkservices/iarmmgrs/dsmgr/Makefile $WORKSPACE/deps/rdk/iarmmgrs/dsmgr
...
# Build HdmiCec
mv $WORKSPACE/deps/rdk/hdmicec/soc/intel/common $WORKSPACE/deps/rdk/hdmicec/soc/intel/common_bkp; 
mv $WORKSPACE/deps/rdk/hdmicec/soc/intel/hdmicec-hal-emulator $WORKSPACE/deps/rdk/hdmicec/soc/intel/common
