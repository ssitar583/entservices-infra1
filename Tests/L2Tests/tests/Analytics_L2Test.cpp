...
#define DEVICE_INFO_MOCK_OUT "estb_mac=01:02:03:04:05:06\nmodel_number=RDK\nfriendly_id=rdkglobal\n"
    ...
    ON_CALL(*p_wrapsImplMock, v_secure_popen(::testing::_, ::testing::_, ::testing::_))
        .WillByDefault(::testing::Invoke(
            [&](const char* direction, const char* command, va_list args) -> FILE* {
                ...
                va_end(args2);
                if (strcmp(strFmt, "/lib/rdk/getDeviceDetails.sh read ") == 0) {
                    valueToReturn = DEVICE_INFO_MOCK_OUT;
                }
