...
############################
# 4. Build rdkservices-apis

git clone https://github-actions:${GITHUB_TOKEN}@github.com/rdk-e/rdkservices-apis.git

cmake -G Ninja -S rdkservices-apis -B build/rdkservices-apis \
  -DCMAKE_INSTALL_PREFIX="install"

cmake --build build/rdkservices-apis --target install
